...
public class PsiTool {
    ...
    private static final String CREATE_DELEGATE_TEMPLATE = "return (%s) java.lang.reflect.Proxy.newProxyInstance(view.getClass().getClassLoader(), new Class[]{%s.class}, new com.mvp.plugin.dependent.delegate.DelegateInvocationHandler(%s));";
